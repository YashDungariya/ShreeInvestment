        ...
        >
          ...
          {selectedCustomer && (
            <Box sx={{ p: 4 }}>
              ...
              <Box
                sx={{ display: "flex", flexWrap: "wrap", gap: "20px", mb: 2 }}
              >
                <InfoBox
                  label="Full Name"
                ...
                <InfoBox
                  label="Mother's Name"
                  value={selectedCustomer.mother_name}
                />
                <InfoBox label="Phone Number" value={selectedCustomer.phone} />
                <InfoBox
                  label="Email ID"
                  value={selectedCustomer.emall || selectedCustomer.email}
                />
                <InfoBox
                  label="Aadhar Number"
              ...
              >
                <InfoBox
                  label="Nominee Name"
                  value={selectedCustomer.nominee_name}
                />
                <InfoBox
                  label="Relationship"
                  value={selectedCustomer.nominee_relation}
                />
                <InfoBox
                  label="Nominee ID"
                  value={selectedCustomer.nominee_id}
                />
                <InfoBox
                  label="Nominee Contact"
                  value={selectedCustomer.nominee_contact}
                />
                <Box sx={{ width: "100%" }}>
                  <InfoBox
                    label="Bank Account Details"
                    value={selectedCustomer.bank_details}
                  />
                </Box>
              </Box>
